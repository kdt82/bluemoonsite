...
const services = [
  ...
  },
  {
    ...
    description: 'Get legitimate software licenses at competitive prices. We are an authorized reseller of Microsoft Office 365 and Bitdefender security solutions.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
