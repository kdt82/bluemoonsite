...
const illawarra_areas = [
  'Wollongong', 'Shellharbour', 'Kiama', 'Dapto', 'Corrimal', 
  'Thirroul', 'Port Kembla', 'Unanderra', 'Fairy Meadow', 'Figtree'
];
...
export default function IllawarraWollongongPage() {
  const openModal = () => {
      ...
      <main className="bg-white">
        ...
        <section className="relative h-[500px] md:h-[600px] overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/assets/hero.jpg"
              alt="IT Support in Illawarra and Wollongong"
              fill
              priority
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
                  Professional IT Support in Illawarra & Wollongong
                </h1>
                <p className="text-xl text-white mb-8">
                  Trusted IT services across the Illawarra region. From Wollongong to Kiama, 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                the entire Illawarra region, including:
              </p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-12">
              {illawarra_areas.map((area, index) => (
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d200325.89676819257!2d150.7469!3d-34.4278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12f7c5a8a7dc1d%3A0x402a35af3deaf30!2sIllawarra%2C%20NSW!5e0!3m2!1sen!2sau!4v1703168000000!5m2!1sen!2sau"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Blue Moon IT Service Areas - Illawarra & Wollongong"
              ></iframe>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-4">
                Our Popular Services in Illawarra
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From Wollongong to Port Kembla, we deliver comprehensive IT solutions 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg text-white max-w-4xl mx-auto mb-8">
                We understand the unique needs of Illawarra residents and businesses. 
                Whether you're in central Wollongong or coastal Thirroul, we provide 
                reliable, personalised IT support that keeps you connected and productive.
              </p>
