...
const shoalhaven_areas = [
  'Nowra', 'Berry', 'Bomaderry', 'Culburra Beach', 'Huskisson', 
  'Sussex Inlet', 'Vincentia', 'Sanctuary Point', 'Gerringong'
];
...
export default function ShoalhavenPage() {
  const openModal = () => {
      ...
      <main className="bg-white">
        ...
        <section className="relative h-[500px] md:h-[600px] overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/assets/hero.jpg"
              alt="IT Support in Shoalhaven Region"
              fill
              priority
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
                  Professional IT Support in Shoalhaven
                </h1>
                <p className="text-xl text-white mb-8">
                  Trusted IT services across the Shoalhaven region. From Nowra to Jervis Bay, 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-4">
                Servicing the Shoalhaven Region
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We proudly provide IT support services to homes and businesses across 
                the beautiful Shoalhaven region, including:
              </p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
              {shoalhaven_areas.map((area, index) => (
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d196436.3845982765!2d150.4289!3d-34.8718!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12c4a3b7a5a3d9%3A0x4017d681632bfd0!2sShoalhaven%2C%20NSW!5e0!3m2!1sen!2sau!4v1703168000000!5m2!1sen!2sau"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Blue Moon IT Service Areas - Shoalhaven Region"
              ></iframe>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-4">
                Our Popular Services in Shoalhaven
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From busy Nowra to peaceful Berry, we deliver comprehensive IT solutions 
